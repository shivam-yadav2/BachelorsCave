    ...
    return (
        <>
            <div className="header__about">
                <div className="d-flex flex-lg-row flex-md-column header__about__head  align-items-center  justify-content-start ">
                ...
                <div className="header__about__submain">
                    <div className="d-flex flex-lg-row    header__about__submain__top justify-content-between row">
                    ...
                    <div className="about__submain__tech">
                        <div className="d-flex  justify-content-center align-items-center submain__tech"><img src="/image/technical-support.4031ab2760e4b4878e65.png" className="img-fluid" />
