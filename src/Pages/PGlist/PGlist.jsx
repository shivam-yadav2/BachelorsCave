                            ...
                            <div className="col-lg-10 col-md-10 col-sm-10  p-0">
                                <div className="tab-content" id="pills-tabContent">
                                    <div className="w-100 tab-pane listing__pg show container active" id="room-detail" role="tabpanel" aria-labelledby="room-detail-tab">
                                        <form action="">
                                            <div className="list__room__detail1">
                                                <h3>Room Details</h3>
                                                <hr className="divide" />
                                                <div className="mb-3">
                                                    <label htmlFor="pg-name" className="form-label">PG Name *</label>
                                                    <input type="text" className="form-control" id="pg-name" placeholder="Enter Your PG Name" />
                                                </div>
                                                ...
                                                <div className="list__room__detail2">
                                                    <h4>Provide details about your place to find a tenant soon
                                                    </h4>
                                                    <hr className="divide__room-detail" />
                                                    <div className="row">
                                                        <div className="col-lg-3">
                                                            <div >
                                                                <input type="radio" className="btn-check" name="btnradio" id="btnradio11" autoComplete="off" defaultChecked />
                                                                <label className="btn btn-outline-primary btn__outline__primary Listing__option " htmlFor="btnradio11">
                                                                    <div className="d-flex justify-content-center"    >
                                                                        <img src="/image/Room.png" alt="" />
                                                        ...
                                                        <div className="col-lg-3">
                                                            <div >
                                                                <input type="radio" className="btn-check" name="btnradio" id="btnradio22" autoComplete="off" />
                                                                <label className="btn btn-outline-primary btn__outline__primary Listing__option " htmlFor="btnradio22">
                                                                    <div className="d-flex justify-content-center">
                                                                        <img src="/image/Room.png" alt="" />
                                                                        <img src="/image/Room.png" alt="" />
                                                                    </div>Double</label>
                                                        ...
                                                        <div className="col-lg-3">
                                                            <div >
                                                                <input type="radio" className="btn-check" name="btnradio" id="btnradio33" autoComplete="off" />
                                                                <label className="btn btn-outline-primary btn__outline__primary  Listing__option" htmlFor="btnradio33">
                                                                    <div className="d-flex justify-content-center">
                                                                        <img src="/image/Room.png" alt="" />
                                                                        <img src="/image/Room.png" alt="" />
                                                                        <img src="/image/Room.png" alt="" />
                                                        ...
                                                        <div className="col-lg-3">
                                                            <div >
                                                                <input type="radio" className="btn-check" name="btnradio" id="btnradio44" autoComplete="off" />
                                                                <label className="btn btn-outline-primary btn__outline__primary Listing__option " htmlFor="btnradio44">
                                                                    <div className="d-flex justify-content-center">
                                                                        <img src="/image/Room.png" alt="" />
                                                                        <img src="/image/Room.png" alt="" />
                                                                        <img src="/image/Room.png" alt="" />
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            ...
                                                            <div className="d-flex listing__rent__box align-items-center" style={{
                                                                backgroundColor: "#fff"
                                                            }}>
                                                                <p>₹</p>
                                                                <input type="number" className="" placeholder="Enter Amount" id="exampleInputEmail6" aria-describedby="emailHelp" />
                                                            </div>
                                                    ...
                                                    <div className="row amenities__avail">
                                                        ...
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            ...
                                                            <label className="ms-3" htmlFor="vehicle1">Closet</label><br />
                                                        </div>
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                            <img src="/image/image 34.png" alt="" />
                                                            <label className="ms-3" htmlFor="vehicle1">TV</label><br />
                                                        </div>
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                            <img src="/image/image 36.png" alt="" />
                                                            <label className="ms-3" htmlFor="vehicle1">Bedding</label><br />
                                                        </div>
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                            <img src="/image/image 33.png" alt="" />
                                                            <label className="ms-3" htmlFor="vehicle1">Geyser</label><br />
                                                        </div>
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                            <img src="/image/Group 79.png" alt="" />
                                                            <label className="ms-3" htmlFor="vehicle1">AC</label><br />
                                                        </div>
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                            <img src="/image/image 35.png" alt="" />
                                                            <label className="ms-3" htmlFor="vehicle1">Attached Bathroom</label><br />
                                                        </div>
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                            <img src="/image/desk.png" alt="" />
                                                            <label className="ms-3" htmlFor="vehicle1">Table</label><br />
                                                        </div>
                                                        <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                            <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                            <img src="/image/Group 126.png" alt="" />
                                                            <label className="ms-3" htmlFor="vehicle1">Meal Included</label><br />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <form action="">
                                            ...
                                            <div className="row amenities__avail">
                                                ...
                                                <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                    ...
                                                    <label className="ms-3" htmlFor="vehicle1">Common TV</label><br />
                                                </div>
                                                <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                    <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                    <img src="/image/Frame 50.png" alt="" />
                                                    <label className="ms-3" htmlFor="vehicle1">Lift</label><br />
                                                </div>
                                                <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                    <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                    <img src="/image/Vector (8).png" alt="" />
                                                    <label className="ms-3" htmlFor="vehicle1">Refrigerator</label><br />
                                                </div>
                                                <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                    <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                    <img src="/image/Vector (9).png" alt="" />
                                                    <label className="ms-3" htmlFor="vehicle1">Mess</label><br />
                                                </div>
                                                <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                    <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                    <img src="/image/Vector (10).png" alt="" />
                                                    <label className="ms-3" htmlFor="vehicle1">Wifi</label><br />
                                                </div>
                                                <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                    <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                    <img src="/image/Group 85.png" alt="" />
                                                    <label className="ms-3" htmlFor="vehicle1">Power backup</label><br />
                                                </div>
                                                <div className="col-lg-4 mt-3 d-flex align-items-center hostel__rules">
                                                    <input type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Bike" />
                                                    <img src="/image/Vector (11).png" alt="" />
                                                    <label className="ms-3" htmlFor="vehicle1">Cooking Allowed</label><br />
                                                </div>
                                            </div>
